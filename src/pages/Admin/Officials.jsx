    ...
    <div className="p-6">
        ...
        <div className="grid grid-cols-1 gap-6">
            {officials.map((off, index) => (
                <div
                key={off.regno}
                className="flex gap-6 shadow-md hover:shadow-xl transition p-5 rounded-2xl"
                >
                ...
                <div className="w-1/3 flex flex-col items-center justify-center border-r pr-4">
                    ...
                    <img
                    src={off.image || `https://codersclub-i9xo.onrender.com/${data.image}`}
                    alt="No Image found"
                    className="w-28 h-28 object-cover mb-3 border"
                    />

                    <input
                    type="file"
                    onChange={(e) =>
                        handleImageChange(off.regno, e.target.files[0])
                    }
                    className="text-sm mb-2"
                    />

                    <button
                    onClick={() => handleImageUpload(off.regno)}
                ...
                <div className="w-2/3">
                    ...
                    <input
                    value={off.prof}
                    onChange={(e) => handleChange(index, "prof", e.target.value)}
                    className="border p-2 w-full mb-2 rounded-lg"
                    ...
                    <button
                        onClick={() => handleDelete(off.regno)}
